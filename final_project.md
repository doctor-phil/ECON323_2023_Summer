...
* Final project **proposal** is **due** on **June 1st**
  ...
  * If you decide to work in a group, then you should say something about how work will be divided and coordinated in the project proposal.
* The final project is **due the week of the final exam.** A final deadline will be announced when the exam is scheduled.
* Your proposal may also include a timeline that breaks the project into steps and describes when you plan to have them completed.
...
* You may work alone or with a group of up to four students. If you work in a group, the project must clearly delineate the contributions of each team member.
